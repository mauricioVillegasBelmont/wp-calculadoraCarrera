...
export default function DesgloseCarrera({children}:DesgloseCarreraProps){
  ...
  return(
    <div className="bg-white p-6 rounded-lg shadow mb-8">
        <h2 className="text-xl font-bold text-emerald-800 mb-6">Desglose por Semestre</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Costo Sin Beca</th>
              </tr>
            </thead>
        ...
        <div className="">
          <h3 className="text-lg font-medium mb-4">Gráfica de Costos por Semestre</h3>
          {children}
        </div>
      </div>
  )
